...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::s_contacts::PeopleInfo, _impl_.birth_),
...
const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "fo\022\014\n\004name\030\001 \001(\t\022\r\n\005birth\030\004 \001(\005\022+\n\005phone"
  "\030\003 \003(\0132\034.s_contacts.PeopleInfo.Phone\032\027\n\005"
  "Phone\022\016\n\006number\030\001 \001(\tJ\004\010\002\020\003\"4\n\010Contacts\022"
  "(\n\010contacts\030\001 \003(\0132\026.s_contacts.PeopleInf"
  "ob\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_contacts_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 209, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
...
PeopleInfo::PeopleInfo(const PeopleInfo& from)
  ...
  _this->_impl_.birth_ = from._impl_.birth_;
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _impl_.birth_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* PeopleInfo::_InternalSerialize(
  ...
  if (this->_internal_birth() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(4, this->_internal_birth(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:s_contacts.PeopleInfo)
  ...
  // int32 birth = 4;
  if (this->_internal_birth() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_birth());
  }
...
void PeopleInfo::InternalSwap(PeopleInfo* other) {
  ...
  swap(_impl_.birth_, other->_impl_.birth_);
}
