...
PROTOBUF_NAMESPACE_OPEN
template<> ::s_contacts::Contacts* Arena::CreateMaybeMessage<::s_contacts::Contacts>(Arena*);
template<> ::s_contacts::PeopleInfo* Arena::CreateMaybeMessage<::s_contacts::PeopleInfo>(Arena*);
template<> ::s_contacts::PeopleInfo_Phone* Arena::CreateMaybeMessage<::s_contacts::PeopleInfo_Phone>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace s_contacts {
...
class PeopleInfo_Phone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:s_contacts.PeopleInfo.Phone) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "s_contacts.PeopleInfo.Phone";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:s_contacts.PeopleInfo.Phone)
 private:
  class _Internal;
...
class PeopleInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:s_contacts.PeopleInfo) */ {
 public:
  ...
  public:
  void clear_phone();
  ::s_contacts::PeopleInfo_Phone* mutable_phone(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo_Phone >*
      mutable_phone();
  private:
  const ::s_contacts::PeopleInfo_Phone& _internal_phone(int index) const;
  ::s_contacts::PeopleInfo_Phone* _internal_add_phone();
  public:
  const ::s_contacts::PeopleInfo_Phone& phone(int index) const;
  ::s_contacts::PeopleInfo_Phone* add_phone();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo_Phone >&
      phone() const;
  ...
  void clear_birth();
  int32_t birth() const;
  void set_birth(int32_t value);
  private:
  int32_t _internal_birth() const;
  void _internal_set_birth(int32_t value);
  public:

  // @@protoc_insertion_point(class_scope:s_contacts.PeopleInfo)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo_Phone > phone_;
...
class Contacts final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:s_contacts.Contacts) */ {
 public:
  ...
  public:
  void clear_contacts();
  ::s_contacts::PeopleInfo* mutable_contacts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo >*
      mutable_contacts();
  private:
  const ::s_contacts::PeopleInfo& _internal_contacts(int index) const;
  ::s_contacts::PeopleInfo* _internal_add_contacts();
  public:
  const ::s_contacts::PeopleInfo& contacts(int index) const;
  ::s_contacts::PeopleInfo* add_contacts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo >&
      contacts() const;

  // @@protoc_insertion_point(class_scope:s_contacts.Contacts)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo > contacts_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_contacts_2eproto;
...
inline const std::string& PeopleInfo_Phone::number() const {
  // @@protoc_insertion_point(field_get:s_contacts.PeopleInfo.Phone.number)
...
void PeopleInfo_Phone::set_number(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:s_contacts.PeopleInfo.Phone.number)
}
inline std::string* PeopleInfo_Phone::mutable_number() {
  std::string* _s = _internal_mutable_number();
  // @@protoc_insertion_point(field_mutable:s_contacts.PeopleInfo.Phone.number)
  return _s;
}
...
inline std::string* PeopleInfo_Phone::release_number() {
  // @@protoc_insertion_point(field_release:s_contacts.PeopleInfo.Phone.number)
...
inline void PeopleInfo_Phone::set_allocated_number(std::string* number) {
  ...
  // @@protoc_insertion_point(field_set_allocated:s_contacts.PeopleInfo.Phone.number)
}
...
inline const std::string& PeopleInfo::name() const {
  // @@protoc_insertion_point(field_get:s_contacts.PeopleInfo.name)
...
void PeopleInfo::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:s_contacts.PeopleInfo.name)
}
inline std::string* PeopleInfo::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:s_contacts.PeopleInfo.name)
  return _s;
}
...
inline std::string* PeopleInfo::release_name() {
  // @@protoc_insertion_point(field_release:s_contacts.PeopleInfo.name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:s_contacts.PeopleInfo.name)
}

// int32 birth = 4;
inline void PeopleInfo::clear_birth() {
  _impl_.birth_ = 0;
}
inline int32_t PeopleInfo::_internal_birth() const {
  return _impl_.birth_;
}
inline int32_t PeopleInfo::birth() const {
  // @@protoc_insertion_point(field_get:s_contacts.PeopleInfo.birth)
  return _internal_birth();
}
inline void PeopleInfo::_internal_set_birth(int32_t value) {
  
  _impl_.birth_ = value;
}
inline void PeopleInfo::set_birth(int32_t value) {
  _internal_set_birth(value);
  // @@protoc_insertion_point(field_set:s_contacts.PeopleInfo.birth)
}
...
inline ::s_contacts::PeopleInfo_Phone* PeopleInfo::mutable_phone(int index) {
  // @@protoc_insertion_point(field_mutable:s_contacts.PeopleInfo.phone)
  return _impl_.phone_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo_Phone >*
PeopleInfo::mutable_phone() {
  // @@protoc_insertion_point(field_mutable_list:s_contacts.PeopleInfo.phone)
  return &_impl_.phone_;
}
inline const ::s_contacts::PeopleInfo_Phone& PeopleInfo::_internal_phone(int index) const {
  return _impl_.phone_.Get(index);
}
inline const ::s_contacts::PeopleInfo_Phone& PeopleInfo::phone(int index) const {
  // @@protoc_insertion_point(field_get:s_contacts.PeopleInfo.phone)
  return _internal_phone(index);
}
inline ::s_contacts::PeopleInfo_Phone* PeopleInfo::_internal_add_phone() {
  return _impl_.phone_.Add();
}
inline ::s_contacts::PeopleInfo_Phone* PeopleInfo::add_phone() {
  ::s_contacts::PeopleInfo_Phone* _add = _internal_add_phone();
  // @@protoc_insertion_point(field_add:s_contacts.PeopleInfo.phone)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo_Phone >&
PeopleInfo::phone() const {
  // @@protoc_insertion_point(field_list:s_contacts.PeopleInfo.phone)
  return _impl_.phone_;
}
...
inline ::s_contacts::PeopleInfo* Contacts::mutable_contacts(int index) {
  // @@protoc_insertion_point(field_mutable:s_contacts.Contacts.contacts)
  return _impl_.contacts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo >*
Contacts::mutable_contacts() {
  // @@protoc_insertion_point(field_mutable_list:s_contacts.Contacts.contacts)
  return &_impl_.contacts_;
}
inline const ::s_contacts::PeopleInfo& Contacts::_internal_contacts(int index) const {
  return _impl_.contacts_.Get(index);
}
inline const ::s_contacts::PeopleInfo& Contacts::contacts(int index) const {
  // @@protoc_insertion_point(field_get:s_contacts.Contacts.contacts)
  return _internal_contacts(index);
}
inline ::s_contacts::PeopleInfo* Contacts::_internal_add_contacts() {
  return _impl_.contacts_.Add();
}
inline ::s_contacts::PeopleInfo* Contacts::add_contacts() {
  ::s_contacts::PeopleInfo* _add = _internal_add_contacts();
  // @@protoc_insertion_point(field_add:s_contacts.Contacts.contacts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::s_contacts::PeopleInfo >&
Contacts::contacts() const {
  // @@protoc_insertion_point(field_list:s_contacts.Contacts.contacts)
  return _impl_.contacts_;
}
