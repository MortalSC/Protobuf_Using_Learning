...
#ifndef GOOGLE_PROTOBUF_INCLUDED_contacts2_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_contacts2_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_contacts2_2eproto
...
struct TableStruct_contacts2_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_contacts2_2eproto;
namespace contacts2 {
class Address;
...
enum PeopleInfo_Phone_PhoneType : int {
  PeopleInfo_Phone_PhoneType_MT = 0,
...
constexpr PeopleInfo_Phone_PhoneType PeopleInfo_Phone_PhoneType_PhoneType_MIN = PeopleInfo_Phone_PhoneType_MT;
...
class Address final :
 ...
 public:
  ...
  // string work_addr = 2;
  void clear_work_addr();
  const std::string& work_addr() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_work_addr(ArgT0&& arg0, ArgT... args);
  std::string* mutable_work_addr();
  PROTOBUF_NODISCARD std::string* release_work_addr();
  void set_allocated_work_addr(std::string* work_addr);
  private:
  const std::string& _internal_work_addr() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_work_addr(const std::string& value);
  std::string* _internal_mutable_work_addr();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr work_addr_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_contacts2_2eproto;
};
// -------------------------------------------------------------------
...
class PeopleInfo_Phone final :
 ...
 public:
  ...
  static constexpr PhoneType MT =
    PeopleInfo_Phone_PhoneType_MT;
...
class Contacts final :
 ...
 public:
  ...
  public:
  void clear_people();
  ::contacts2::PeopleInfo* mutable_people(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::PeopleInfo >*
      mutable_people();
  private:
  const ::contacts2::PeopleInfo& _internal_people(int index) const;
  ::contacts2::PeopleInfo* _internal_add_people();
  public:
  const ::contacts2::PeopleInfo& people(int index) const;
  ::contacts2::PeopleInfo* add_people();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::PeopleInfo > people_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_contacts2_2eproto;
...
inline const std::string& Address::home_addr() const {
  // @@protoc_insertion_point(field_get:contacts2.Address.home_addr)
...
void Address::set_home_addr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.home_addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts2.Address.home_addr)
}
inline std::string* Address::mutable_home_addr() {
  std::string* _s = _internal_mutable_home_addr();
  // @@protoc_insertion_point(field_mutable:contacts2.Address.home_addr)
  return _s;
}
...
inline std::string* Address::release_home_addr() {
  // @@protoc_insertion_point(field_release:contacts2.Address.home_addr)
...
inline void Address::set_allocated_home_addr(std::string* home_addr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:contacts2.Address.home_addr)
}

// string work_addr = 2;
inline void Address::clear_work_addr() {
  _impl_.work_addr_.ClearToEmpty();
}
inline const std::string& Address::work_addr() const {
  // @@protoc_insertion_point(field_get:contacts2.Address.work_addr)
  return _internal_work_addr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Address::set_work_addr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.work_addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts2.Address.work_addr)
}
inline std::string* Address::mutable_work_addr() {
  std::string* _s = _internal_mutable_work_addr();
  // @@protoc_insertion_point(field_mutable:contacts2.Address.work_addr)
  return _s;
}
inline const std::string& Address::_internal_work_addr() const {
  return _impl_.work_addr_.Get();
}
inline void Address::_internal_set_work_addr(const std::string& value) {
  
  _impl_.work_addr_.Set(value, GetArenaForAllocation());
}
inline std::string* Address::_internal_mutable_work_addr() {
  
  return _impl_.work_addr_.Mutable(GetArenaForAllocation());
}
inline std::string* Address::release_work_addr() {
  // @@protoc_insertion_point(field_release:contacts2.Address.work_addr)
  return _impl_.work_addr_.Release();
}
inline void Address::set_allocated_work_addr(std::string* work_addr) {
  if (work_addr != nullptr) {
    
  } else {
    
  }
  _impl_.work_addr_.SetAllocated(work_addr, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.work_addr_.IsDefault()) {
    _impl_.work_addr_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contacts2.Address.work_addr)
}
...
inline ::contacts2::PeopleInfo* Contacts::mutable_people(int index) {
  // @@protoc_insertion_point(field_mutable:contacts2.Contacts.people)
...
Contacts::mutable_people() {
  // @@protoc_insertion_point(field_mutable_list:contacts2.Contacts.people)
  return &_impl_.people_;
}
inline const ::contacts2::PeopleInfo& Contacts::_internal_people(int index) const {
  return _impl_.people_.Get(index);
}
inline const ::contacts2::PeopleInfo& Contacts::people(int index) const {
  // @@protoc_insertion_point(field_get:contacts2.Contacts.people)
  return _internal_people(index);
}
inline ::contacts2::PeopleInfo* Contacts::_internal_add_people() {
  return _impl_.people_.Add();
}
inline ::contacts2::PeopleInfo* Contacts::add_people() {
  ::contacts2::PeopleInfo* _add = _internal_add_people();
  // @@protoc_insertion_point(field_add:contacts2.Contacts.people)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::PeopleInfo >&
Contacts::people() const {
  // @@protoc_insertion_point(field_list:contacts2.Contacts.people)
  return _impl_.people_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_contacts2_2eproto
